...
class ChattyModePage extends StatefulWidget {
  const ChattyModePage({super.key});

  @override
  State<ChattyModePage> createState() => _ChattyModePageState();
}

class _ChattyModePageState extends State<ChattyModePage> {
...
Future<void> _getAIResponse(String userMessage) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Chatty Mode 🎵")),
      body: Padding(
